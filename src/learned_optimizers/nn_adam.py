...
class _Invertable:
  ...
  def __init__(self, forward: Callable[[jax.Array], jax.Array],
...
def _sorted_values(
    value_dict: Mapping[str, jax.Array]) -> Sequence[jax.Array]:
...
class NNAdam(lopt_base.LearnedOptimizer):
  ...
  def opt_fn(self,
    ...
    class _Opt(opt_base.Optimizer):
      ...
      def lstm_features_for_tensor(self, p: jax.Array, g: jax.Array,
                                   m: jax.Array, rms: jax.Array,
                                   lr: jax.Array, beta1: jax.Array,
                                   beta2: jax.Array,
